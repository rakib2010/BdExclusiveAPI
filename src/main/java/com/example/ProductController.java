...
public class ProductController {
    ...
    @GetMapping(value = "/product/search/{searchText}")
    @Transactional
    public ResponseEntity<?> getProductsBySearch(@PathVariable (value = "searchText", required = false) String searchText) {
        try {
            Session session = sessionFactory.openSession();
            Query q = session.createQuery("from Product where productName like :productName");
            
            q.setParameter("productName","%"+ searchText +"%");
